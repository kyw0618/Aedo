...
import com.aedo.my_heaven.databinding.ActivityFiveOrderBinding
...
class FiveOrderActivity : BaseActivity() {
    private lateinit var mBinding: ActivityFiveOrderBinding
    private lateinit var apiServices: APIService

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        mBinding = DataBindingUtil.setContentView(this,R.layout.activity_five_order)
        Iamport.init(this)
    ...
    private fun initView() {
        val name = intent.getStringExtra(SHOP_FIVE).toString()
        val pay = intent.getStringExtra(SHOP_FIVE_PAY)
