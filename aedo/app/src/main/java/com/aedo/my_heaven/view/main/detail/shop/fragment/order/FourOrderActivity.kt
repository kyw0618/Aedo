...
import com.aedo.my_heaven.databinding.ActivityFourOrderBinding
...
class FourOrderActivity : BaseActivity() {
    private lateinit var mBinding: ActivityFourOrderBinding
    private lateinit var apiServices: APIService

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        mBinding = DataBindingUtil.setContentView(this,R.layout.activity_four_order)
        Iamport.init(this)
    ...
    private fun initView() {
        val name = intent.getStringExtra(SHOP_FOUR).toString()
        val pay = intent.getStringExtra(SHOP_FOUR_PAY)
