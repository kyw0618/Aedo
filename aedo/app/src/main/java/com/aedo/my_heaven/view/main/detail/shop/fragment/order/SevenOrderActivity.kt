...
import com.aedo.my_heaven.databinding.ActivitySevenOrderBinding
...
class SevenOrderActivity : BaseActivity() {
    private lateinit var mBinding: ActivitySevenOrderBinding
    private lateinit var apiServices: APIService

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        mBinding = DataBindingUtil.setContentView(this,R.layout.activity_seven_order)
        Iamport.init(this)
    ...
    private fun initView() {
        val name = intent.getStringExtra(SHOP_SEVEN).toString()
        val pay = intent.getStringExtra(SHOP_SEVEN_PAY)
