...
import com.aedo.my_heaven.databinding.ActivitySixOrderBinding
...
class SixOrderActivity : BaseActivity() {
    private lateinit var mBinding: ActivitySixOrderBinding
    private lateinit var apiServices: APIService

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        mBinding = DataBindingUtil.setContentView(this,R.layout.activity_six_order)
        Iamport.init(this)
    ...
    private fun initView() {
        val name = intent.getStringExtra(SHOP_SIX).toString()
        val pay = intent.getStringExtra(SHOP_SIX_PAY)
