...
import com.aedo.my_heaven.databinding.ActivityTwoOrderBinding
...
class TwoOrderActivity : BaseActivity() {
    private lateinit var mBinding: ActivityTwoOrderBinding
    private lateinit var apiServices: APIService

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        mBinding = DataBindingUtil.setContentView(this,R.layout.activity_two_order)
        Iamport.init(this)
    ...
    private fun initView() {
        val name = intent.getStringExtra(SHOP_SECOND).toString()
        val pay = intent.getStringExtra(SHOP_SECOND_PAY)
